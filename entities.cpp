...
void Project::fromJson(QJsonDocument doc)
{
    ...
    {
        m_events.append(Event{
            .uuid = QUuid::fromString(event.toObject()["uuid"].toString()),
    ...
    {
        m_components.append(Component{
            .uuid = QUuid::fromString(component.toObject()["uuid"].toString()),
    ...
    for (const auto &bus : qAsConst(buses))
    {
        ...
        auto busEntity = Bus{
            .uuid = QUuid::fromString(busObj["uuid"].toString()),
        ...
        for (const auto &section : busObj["sections"].toArray())
        {
            ...
            auto sectionEntity = Section{
                .uuid = QUuid::fromString(sectionObj["uuid"].toString()),
                .component = QUuid::fromString(sectionObj["component"].toString()),
                .type = Section::SectionType(sectionObj["type"].toInt()),
                .referenceStartEvent = QUuid::fromString(sectionObj["startRef"].toString()),
                .start = sectionObj["startOffset"].toInt(),
                .referenceEndEvent = QUuid::fromString(sectionObj["endRef"].toString()),
